 ...
 * @param defaultMenuBuilder The [BrowserMenuBuilder] to add the new custom tab menu items to.
 */
internal class CustomTabsNavigationBarIntegration(
    private val context: Context,
    private val browserStore: BrowserStore,
    private val customTabSessionId: String,
    private val defaultMenuBuilder: BrowserMenuBuilder,
) {
    /**
     ...
     */
    val navbarMenu by lazy {
        MenuButton(context).apply {
            menuBuilder = defaultMenuBuilder.addCustomMenuItems(
                context = context,
