...
class ContentBlockingControllerTest : BaseSessionTest() {
    ...
    fun allowListTrackingProtectionSettings() {
        ...
        assertThat(
            "Expect correct default for allowListConvenienceTrackingProtection value which is false",
        ...
        contentBlocking.allowListConvenienceTrackingProtection = true
        ...
        // Set a new pref value, with a different setter method.
        contentBlocking.setAllowListConvenienceTrackingProtection(false)
