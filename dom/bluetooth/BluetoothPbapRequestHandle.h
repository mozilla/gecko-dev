...
public:
  ...
  already_AddRefed<DOMRequest> ReplyTovCardPulling(File& aBlob,
                                                   ErrorResult& aRv);

  already_AddRefed<DOMRequest> ReplyToPhonebookPulling(File& aBlob,
                                                       uint16_t phonebookSize,
                                                       ErrorResult& aRv);

  already_AddRefed<DOMRequest> ReplyTovCardListing(File& aBlob,
                                                   uint16_t phonebookSize,
                                                   ErrorResult& aRv);
