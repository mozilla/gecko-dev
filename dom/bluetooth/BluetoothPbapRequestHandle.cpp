...
BluetoothPbapRequestHandle::ReplyTovCardPulling(File& aBlob,
                                                ErrorResult& aRv)
{
...
already_AddRefed<DOMRequest>
BluetoothPbapRequestHandle::ReplyToPhonebookPulling(File& aBlob,
...
already_AddRefed<DOMRequest>
BluetoothPbapRequestHandle::ReplyTovCardListing(File& aBlob,
                                                uint16_t phonebookSize,
                                                ErrorResult& aRv)
{
  // TODO: Implement this function (Bug 1180555)
...
{
  return BluetoothPbapRequestHandleBinding::Wrap(aCx, this);
}
