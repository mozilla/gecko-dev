...
bool AnimationEffectReadOnly::IsCurrent() const {
...
bool AnimationEffectReadOnly::IsInEffect() const {
  ComputedTiming computedTiming = GetComputedTiming();
...
void AnimationEffectReadOnly::SetSpecifiedTiming(const TimingParams& aTiming) {
...
ComputedTiming AnimationEffectReadOnly::GetComputedTimingAt(
...
ComputedTiming AnimationEffectReadOnly::GetComputedTiming(
...
static void GetComputedTimingDictionary(
...
void AnimationEffectReadOnly::GetComputedTimingAsDict(
  ...
  GetComputedTimingDictionary(
      ...
      currentTime, SpecifiedTiming(), aRetVal);
}
...
Nullable<TimeDuration> AnimationEffectReadOnly::GetLocalTime() const {
