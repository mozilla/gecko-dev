...
static cdm::EncryptionScheme ConvertToCdmEncryptionScheme(
    const GMPEncryptionScheme& aEncryptionScheme, uint64_t aNumCipherBytes) {
  ...
  if (aEncryptionScheme == GMPEncryptionScheme::kGMPEncryptionNone) {
    GMP_LOG(
        "ChromiumCDMChild::ConvertToCdmEncryptionScheme() got scheme "
...
static void InitInputBuffer(const CDMInputBuffer& aBuffer,
  ...
  if (aBuffer.mEncryptionScheme() > GMPEncryptionScheme::kGMPEncryptionNone) {
    ...
    aInputBuffer.encryption_scheme = ConvertToCdmEncryptionScheme(
        aBuffer.mEncryptionScheme(), numCipherBytes);
  }
