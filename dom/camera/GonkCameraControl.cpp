...
void
nsGonkCameraControl::GetParameter(uint32_t aKey, CameraSize& aSize)
{
...
void
nsGonkCameraControl::SetParameter(uint32_t aKey, const CameraSize& aSize)
{
  switch (aKey) {
    case CAMERA_PARAM_PICTURESIZE:
...
nsGonkCameraControl::SetThumbnailSize(uint32_t aWidth, uint32_t aHeight)
{
  ...
  nsAutoTArray<CameraSize, 8> supportedSizes;
