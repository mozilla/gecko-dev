...
// Can't NS_IMPL_CYCLE_COLLECTION_1 because mDOMCursor is ambiguous.
NS_IMPL_CYCLE_COLLECTION_CLASS(MobileMessageCursorCallback)

NS_IMPL_CYCLE_COLLECTION_UNLINK_BEGIN(MobileMessageCursorCallback)
NS_IMPL_CYCLE_COLLECTION_UNLINK_NSCOMPTR(mDOMCursor)
NS_IMPL_CYCLE_COLLECTION_UNLINK_END

NS_IMPL_CYCLE_COLLECTION_TRAVERSE_BEGIN(MobileMessageCursorCallback)
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_NSCOMPTR_AMBIGUOUS(mDOMCursor, nsIDOMDOMRequest)
