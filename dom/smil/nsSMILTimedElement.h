...
class nsSMILTimedElement {
 ...
 protected:
  ...
  nsresult SetBeginSpec(const nsAString& aBeginSpec, Element* aContextNode,
                        RemovalTestFunction aRemove);
  nsresult SetEndSpec(const nsAString& aEndSpec, Element* aContextNode,
                      RemovalTestFunction aRemove);
  ...
  nsresult SetBeginOrEndSpec(const nsAString& aSpec, Element* aContextNode,
