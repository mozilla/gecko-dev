...
SmsDatabaseService.prototype = {
  ...
  saveMessage: function saveMessage(aMessageRecord, aAddresses, aCallback) {
  ...
  saveReceivedMessage: function saveReceivedMessage(
    ...
    return this.saveMessage(messageRecord, [messageRecord.sender], aCallback);
  },
  ...
  saveSendingMessage: function saveSendingMessage(
    ...
    return this.saveMessage(messageRecord, [messageRecord.receiver], aCallback);
  },
