...
nsSVGElement::LengthInfo SVGMarkerElement::sLengthInfo[4] = {
    {&nsGkAtoms::refX, 0, SVGLengthBinding::SVG_LENGTHTYPE_NUMBER,
     SVGContentUtils::X},
    {&nsGkAtoms::refY, 0, SVGLengthBinding::SVG_LENGTHTYPE_NUMBER,
     SVGContentUtils::Y},
    {&nsGkAtoms::markerWidth, 3, SVGLengthBinding::SVG_LENGTHTYPE_NUMBER,
     SVGContentUtils::X},
    {&nsGkAtoms::markerHeight, 3, SVGLengthBinding::SVG_LENGTHTYPE_NUMBER,
     SVGContentUtils::Y},
};
...
/* static */ bool SVGMarkerElement::MarkerImprovementsPrefEnabled() {
