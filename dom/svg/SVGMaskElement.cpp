...
nsSVGElement::LengthInfo SVGMaskElement::sLengthInfo[4] = {
    {&nsGkAtoms::x, -10, SVGLengthBinding::SVG_LENGTHTYPE_PERCENTAGE,
     SVGContentUtils::X},
    {&nsGkAtoms::y, -10, SVGLengthBinding::SVG_LENGTHTYPE_PERCENTAGE,
     SVGContentUtils::Y},
    {&nsGkAtoms::width, 120, SVGLengthBinding::SVG_LENGTHTYPE_PERCENTAGE,
     SVGContentUtils::X},
    {&nsGkAtoms::height, 120, SVGLengthBinding::SVG_LENGTHTYPE_PERCENTAGE,
     SVGContentUtils::Y},
};
