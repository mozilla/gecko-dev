 ...
 */
template <typename T>
bool nsTSubstring<T>::MutatePrep(size_type aCapacity, char_type** aOldData,
...
template <typename T>
void nsTSubstring<T>::Assign(const char_type* aData) {
...
template <typename T>
bool nsTSubstring<T>::Assign(const char_type* aData, const fallible_t&) {
...
template <typename T>
void nsTSubstring<T>::Assign(const literalstring_type& aStr) {
