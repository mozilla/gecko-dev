...
__attribute__((unused)) static void nsObjCExceptionLog(
    NSException* aException) {
  ...
  @try {
    ...
    if ([aException respondsToSelector:@selector(callStackReturnAddresses)]) {
      NSArray* addresses = (NSArray*)[aException
...
__attribute__((unused)) static void nsObjCExceptionLogAbort(
    NSException* aException) {
