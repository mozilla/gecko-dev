...
#define NS_WIN_DESKTOP_DIR \
  "DeskV"  // virtual folder at the root of the namespace
...
#define NS_WIN_DESKTOP_DIRECTORY \
  "DeskP"  // file sys dir which physically stores objects on desktop
