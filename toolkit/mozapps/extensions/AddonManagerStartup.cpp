...
Result<Ok, nsresult> AddonManagerStartup::AddInstallLocation(Addon& addon) {
  nsCOMPtr<nsIFile> file;
...
nsresult AddonManagerStartup::InitializeExtensions(JS::HandleValue locations,
                                                   JSContext* cx) {
...
nsresult AddonManagerStartup::Reset() {
