...
nsresult UrlClassifierDBServiceWorkerProxy::OpenDb() {
  nsCOMPtr<nsIRunnable> r =
...
nsresult UrlClassifierDBServiceWorkerProxy::CloseDb() {
  nsCOMPtr<nsIRunnable> r =
...
nsresult UrlClassifierDBServiceWorkerProxy::PreShutdown() {
  nsCOMPtr<nsIRunnable> r =
