...
export class FutureTester {
    ...
    static init() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                143, // futures:uniffi_uniffi_fixture_futures_fn_constructor_futuretester_init
            )
        }
    ...
    completeFutures(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                140, // futures:uniffi_uniffi_fixture_futures_fn_method_futuretester_complete_futures
    ...
    makeFuture() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                141, // futures:uniffi_uniffi_fixture_futures_fn_method_futuretester_make_future
                FfiConverterTypeFutureTester.lower(this),
            )
        }
        try {
    ...
    wakeFutures() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                142, // futures:uniffi_uniffi_fixture_futures_fn_method_futuretester_wake_futures
                FfiConverterTypeFutureTester.lower(this),
            )
        }
        return handleRustResult(functionCall(), liftResult, liftError);
...
export class RustTask {
    ...
    run() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                144, // futures:uniffi_uniffi_fixture_futures_fn_method_rusttask_run
...
export class Traveller {
    ...
    static init(name) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                146, // futures:uniffi_uniffi_fixture_futures_fn_constructor_traveller_new
    ...
    name() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                145, // futures:uniffi_uniffi_fixture_futures_fn_method_traveller_name
...
export class WorkerQueue {
    ...
    addTask(task) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                147, // futures:uniffi_uniffi_fixture_futures_fn_method_workerqueue_add_task
...
export function expensiveComputation() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                123, // futures:uniffi_uniffi_fixture_futures_fn_func_expensive_computation
            )
        }
        try {
            return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
...
export function initializeGeckoGlobalWorkerQueue() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                124, // futures:uniffi_uniffi_fixture_futures_fn_func_initialize_gecko_global_worker_queue
            )
        }
        return handleRustResult(functionCall(), liftResult, liftError);
}
...
export function initializeGlobalWorkerQueue(workerQueue) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                125, // futures:uniffi_uniffi_fixture_futures_fn_func_initialize_global_worker_queue
...
export function roundtripF32(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                126, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_f32
...
export function roundtripF64(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                127, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_f64
...
export function roundtripI16(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                128, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_i16
...
export function roundtripI32(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                129, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_i32
...
export function roundtripI64(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                130, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_i64
...
export function roundtripI8(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                131, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_i8
...
export function roundtripMap(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                132, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_map
...
export function roundtripObj(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                133, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_obj
...
export function roundtripString(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                134, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_string
...
export function roundtripU16(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                135, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_u16
...
export function roundtripU32(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                136, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_u32
...
export function roundtripU64(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                137, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_u64
...
export function roundtripU8(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                138, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_u8
...
export function roundtripVec(v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                139, // futures:uniffi_uniffi_fixture_futures_fn_func_roundtrip_vec
