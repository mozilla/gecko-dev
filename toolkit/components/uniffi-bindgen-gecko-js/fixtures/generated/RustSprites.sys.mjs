...
export class Sprite {
    ...
    getPosition() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                131, // sprites:uniffi_uniffi_sprites_fn_method_sprite_get_position
    ...
    moveBy(direction) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                132, // sprites:uniffi_uniffi_sprites_fn_method_sprite_move_by
                FfiConverterTypeSprite.lower(this),
                FfiConverterTypeVector.lower(direction),
            )
        }
    ...
    moveTo(position) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                133, // sprites:uniffi_uniffi_sprites_fn_method_sprite_move_to
                FfiConverterTypeSprite.lower(this),
...
export function translate(position,direction) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                130, // sprites:uniffi_uniffi_sprites_fn_func_translate
                FfiConverterTypePoint.lower(position),
                FfiConverterTypeVector.lower(direction),
            )
        }
