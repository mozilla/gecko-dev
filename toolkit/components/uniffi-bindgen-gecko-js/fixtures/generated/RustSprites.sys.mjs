...
export class Sprite {
    ...
    static init(initialPosition) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                217, // sprites:uniffi_uniffi_sprites_fn_constructor_sprite_new
    ...
    static newRelativeTo(reference,direction) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                218, // sprites:uniffi_uniffi_sprites_fn_constructor_sprite_new_relative_to
    ...
    getPosition() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsyncWrapper(
                214, // sprites:uniffi_uniffi_sprites_fn_method_sprite_get_position
    ...
    moveBy(direction) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                215, // sprites:uniffi_uniffi_sprites_fn_method_sprite_move_by
                FfiConverterTypeSprite.lower(this),
                FfiConverterTypeVector.lower(direction),
            )
        }
    ...
    moveTo(position) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                216, // sprites:uniffi_uniffi_sprites_fn_method_sprite_move_to
                FfiConverterTypeSprite.lower(this),
...
export function translate(p,v) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                213, // sprites:uniffi_uniffi_sprites_fn_func_translate
