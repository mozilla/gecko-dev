...
export function echoExplicitValue(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                108, // custom_types:uniffi_uniffi_custom_types_fn_func_echo_explicit_value
...
export function echoGappedValue(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                109, // custom_types:uniffi_uniffi_custom_types_fn_func_echo_gapped_value
...
export function echoSequentialValue(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                110, // custom_types:uniffi_uniffi_custom_types_fn_func_echo_sequential_value
...
export function getCustomTypesDemo(demo) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                111, // custom_types:uniffi_uniffi_custom_types_fn_func_get_custom_types_demo
...
export function getExplicitDiscriminant(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                112, // custom_types:uniffi_uniffi_custom_types_fn_func_get_explicit_discriminant
                FfiConverterTypeExplicitValuedEnum.lower(value),
            )
        }
        try {
...
export function getExplicitEnumValues() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsyncWrapper(
                113, // custom_types:uniffi_uniffi_custom_types_fn_func_get_explicit_enum_values
            )
        }
        try {
            return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
...
export function getGappedDiscriminant(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                114, // custom_types:uniffi_uniffi_custom_types_fn_func_get_gapped_discriminant
                FfiConverterTypeGappedEnum.lower(value),
            )
        }
        try {
...
export function getGappedEnumValues() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsyncWrapper(
                115, // custom_types:uniffi_uniffi_custom_types_fn_func_get_gapped_enum_values
            )
        }
        try {
            return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
...
export function getSequentialDiscriminant(value) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                116, // custom_types:uniffi_uniffi_custom_types_fn_func_get_sequential_discriminant
                FfiConverterTypeSequentialEnum.lower(value),
            )
        }
        try {
