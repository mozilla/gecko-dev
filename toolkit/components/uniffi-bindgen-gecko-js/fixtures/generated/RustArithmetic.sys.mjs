...
export function add(a,b) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                64, // arithmetic:uniffi_arithmetical_fn_func_add
...
export function div(dividend,divisor) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                65, // arithmetic:uniffi_arithmetical_fn_func_div
...
export function equal(a,b) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                66, // arithmetic:uniffi_arithmetical_fn_func_equal
                FfiConverterU64.lower(a),
                FfiConverterU64.lower(b),
            )
        }
...
export function sub(a,b) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsyncWrapper(
                67, // arithmetic:uniffi_arithmetical_fn_func_sub
                FfiConverterU64.lower(a),
                FfiConverterU64.lower(b),
            )
        }
