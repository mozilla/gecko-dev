...
export class WPTMessagesChild extends JSWindowActorChild {
  ...
  actorCreated() {
    ...
    if (!Object.hasOwn(win.wrappedJSObject, "browser")) {
      ChromeUtils.defineLazyGetter(win.wrappedJSObject, "browser", () => {
        let browser = {
          test: {
            onMessage: {
        ...
        return Cu.cloneInto(browser, win, { cloneFunctions: true });
      });
    }
  }
