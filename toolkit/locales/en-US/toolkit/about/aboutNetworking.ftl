...
about-networking-dnssuffix = DNS suffix
...
about-networking-about-networking-http-version = HTTP Version
...
about-networking-networkid-isUp = Link is up
about-networking-networkid-statusKnown = Link status is known
