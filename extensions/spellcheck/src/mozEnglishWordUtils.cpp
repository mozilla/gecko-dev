...
NS_IMETHODIMP mozEnglishWordUtils::GetRootForm(const char16_t *aWord,
                                               uint32_t type, char16_t ***words,
                                               uint32_t *count) {
...
NS_IMETHODIMP mozEnglishWordUtils::FindNextWord(const char16_t *word,
                                                uint32_t length,
                                                uint32_t offset, int32_t *begin,
                                                int32_t *end) {
...
mozEnglishWordUtils::myspCapitalization mozEnglishWordUtils::captype(
    const nsString &word) {
...
NS_IMETHODIMP mozEnglishWordUtils::FromRootForm(const char16_t *aWord,
                                                const char16_t **iwords,
                                                uint32_t icount,
                                                char16_t ***owords,
                                                uint32_t *ocount) {
  nsAutoString word(aWord);
