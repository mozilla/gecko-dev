...
pref("font.name-list.sans-serif.th", "Fira Sans, Droid Sans Thai");
...
pref("font.name.sans-serif.x-user-def", "Fira Sans");
pref("font.name.monospace.x-user-def", "Fira Mono");
