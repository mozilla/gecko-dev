...
add_task(async function () {
  ...
  const initialRequests = [
    "sjs_delay-test-server.sjs?delay=100",
    "sjs_delay-test-server.sjs?delay=200",
    "sjs_delay-test-server.sjs?delay=300",
  ];
  ...
  const newRequests = [
    ...
    "sjs_delay-test-server.sjs?delay=400",
  ];
  ...
  async function testInitialContents([a, b, c]) {
    ...
    is(
      requestItems[a],
      DELAY_SJS + "?delay=100",
      "100ms request sorted correctly."
    );
    is(
      requestItems[b],
      DELAY_SJS + "?delay=200",
      "200ms request sorted correctly."
    );
    is(
      requestItems[c],
      DELAY_SJS + "?delay=300",
      "300ms request sorted correctly."
    );
  }
  ...
  async function testPendingContents([a, b, c, d, e]) {
    ...
    is(
      requestItems[d],
      DELAY_SJS + "?delay=400",
      "400ms request sorted correctly."
    );
    is(
      requestItems[e],
