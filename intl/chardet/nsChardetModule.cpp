...
static const mozilla::Module::CIDEntry kChardetCIDs[] = {
    ...
    {&kNS_RU_STRING_PROBDETECTOR_CID, false, nullptr,
     nsRUStringProbDetectorConstructor},
    {&kNS_UK_STRING_PROBDETECTOR_CID, false, nullptr,
...
static const mozilla::Module::CategoryEntry kChardetCategories[] = {
    ...
    {NS_CHARSET_DETECTOR_CATEGORY, "ruprob",
     NS_CHARSET_DETECTOR_CONTRACTID_BASE "ruprob"},
    {NS_CHARSET_DETECTOR_CATEGORY, "ukprob",
