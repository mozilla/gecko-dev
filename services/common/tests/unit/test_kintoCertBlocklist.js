...
function getSampleResponse(req, port) {
  const responses = {
    ...
    "GET:/v1/?": {
      ...
      "status": {status: 200, statusText: "OK"},
      "responseBody": JSON.stringify({"settings":{"cliquet.batch_max_requests":25}, "url":`http://localhost:${port}/v1/`, "documentation":"https://kinto.readthedocs.io/", "version":"1.5.1", "commit":"cbc6f58", "hello":"kinto"})
    },
