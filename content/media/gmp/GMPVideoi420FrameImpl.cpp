...
void
GMPVideoi420FrameImpl::SetHost(GMPVideoHostImpl* aHost)
{
  mYPlane.SetHost(aHost);
  mUPlane.SetHost(aHost);
  mVPlane.SetHost(aHost);
}

void
GMPVideoi420FrameImpl::ExtractShmem(ipc::Shmem** aYShmem,
                                    ipc::Shmem** aUShmem,
                                    ipc::Shmem** aVShmem)
{
  mYPlane.ExtractShmem(aYShmem);
  mUPlane.ExtractShmem(aUShmem);
  mVPlane.ExtractShmem(aVShmem);
}

void
GMPVideoi420FrameImpl::ReceiveShmem(ipc::Shmem& yShmem,
                                    ipc::Shmem& uShmem,
                                    ipc::Shmem& vShmem)
{
  mYPlane.ReceiveShmem(yShmem);
  mUPlane.ReceiveShmem(uShmem);
  mVPlane.ReceiveShmem(vShmem);
}
