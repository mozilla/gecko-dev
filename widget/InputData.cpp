...
MultiTouchInput::MultiTouchInput()
    : InputData(MULTITOUCH_INPUT), mHandledByAPZ(false) {}
...
PinchGestureInput::PinchGestureInput() : InputData(PINCHGESTURE_INPUT) {}
...
TapGestureInput::TapGestureInput() : InputData(TAPGESTURE_INPUT) {}
