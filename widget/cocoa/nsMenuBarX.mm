...
void nsMenuBarX::ConstructFallbackNativeMenus()
{
  ...
  bundleSvc->CreateBundle("chrome://global/locale/fallbackMenubar.properties", &stringBundle);
  ...
  const char* keyUTF8 = NS_ConvertUTF16toUTF8(keyUTF16).get();

  NSMutableString* labelStr = [NSMutableString stringWithUTF8String:labelUTF8];
  NSMutableString* keyStr = [NSMutableString stringWithUTF8String:keyUTF8];
