...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.39.0:wasi:cli@0.2.4:command:imports and exportsrust-wasi-from-crates-io-command-world")]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.39.0:wasi:cli@0.2.4:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"
)]
#[doc(hidden)]
