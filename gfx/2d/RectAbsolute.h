...
struct BaseRectAbsolute {
 ...
 public:
  ...
  void SetLeftEdge(T aX1) { x1 = aX1; }
  void SetRightEdge(T aX2) { x2 = aX2; }
  void SetTopEdge(T aY1) { y1 = aY1; }
  void SetBottomEdge(T aY2) { y2 = aY2; }
  ...
  bool IsEqualEdges(const Sub& aOther) const {
    return x1 == aOther.x1 && y1 == aOther.y1 && x2 == aOther.x2 &&
           y2 == aOther.y2;
  }
};
