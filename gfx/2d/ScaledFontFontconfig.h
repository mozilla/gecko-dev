...
class ScaledFontFontconfig : public ScaledFontBase {
 ...
 private:
  ...
  static already_AddRefed<ScaledFont> CreateFromInstanceData(
      const InstanceData& aInstanceData, UnscaledFontFontconfig* aUnscaledFont,
      Float aSize, NativeFontResource* aNativeFontResource = nullptr);
