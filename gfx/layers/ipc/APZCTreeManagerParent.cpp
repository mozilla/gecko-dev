...
APZCTreeManagerParent::APZCTreeManagerParent(
    uint64_t aLayersId, RefPtr<APZCTreeManager> aAPZCTreeManager)
    : mLayersId(aLayersId), mTreeManager(aAPZCTreeManager) {
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceiveMultiTouchInputEvent(
  ...
  *aOutStatus =
      mTreeManager->ReceiveInputEvent(event, aOutTargetGuid, aOutInputBlockId);
  *aOutEvent = event;

  return IPC_OK();
}

mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceiveMouseInputEvent(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceivePanGestureInputEvent(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceiveTapGestureInputEvent(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceiveScrollWheelInputEvent(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvReceiveKeyboardInputEvent(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvStopAutoscroll(
  ...
  APZThreadUtils::RunOnControllerThread(NewRunnableMethod<ScrollableLayerGuid>(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvProcessTouchVelocity(
    const uint32_t& aTimestampMs, const float& aSpeedY) {
  mTreeManager->ProcessTouchVelocity(aTimestampMs, aSpeedY);
  return IPC_OK();
}

mozilla::ipc::IPCResult APZCTreeManagerParent::RecvUpdateWheelTransaction(
...
mozilla::ipc::IPCResult APZCTreeManagerParent::RecvProcessUnhandledEvent(
  ...
  mTreeManager->ProcessUnhandledEvent(&refPoint, aOutTargetGuid,
