...
class APZCTreeManagerParent : public PAPZCTreeManagerParent {
 public:
  explicit APZCTreeManagerParent(uint64_t aLayersId,
  ...
  mozilla::ipc::IPCResult RecvProcessTouchVelocity(
      const uint32_t& aTimestampMs, const float& aSpeedY) override;
