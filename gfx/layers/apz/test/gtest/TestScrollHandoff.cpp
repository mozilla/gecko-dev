...
class APZScrollHandoffTester : public APZCTreeManagerTester {
 protected:
  ...
  void CreateScrollHandoffLayerTree2() {
    ...
    SetScrollableFrameMetrics(root, FrameMetrics::START_SCROLL_ID,
                              CSSRect(0, 0, 200, 200));
    SetScrollableFrameMetrics(layers[1], FrameMetrics::START_SCROLL_ID + 2,
  ...
  void CreateScrollHandoffLayerTree3() {
    ...
    SetScrollableFrameMetrics(layers[2], FrameMetrics::START_SCROLL_ID + 2,
                              CSSRect(0, 0, 100, 100));
    SetScrollableFrameMetrics(layers[3], FrameMetrics::START_SCROLL_ID + 3,
                              CSSRect(0, 50, 100, 100));
    SetScrollableFrameMetrics(layers[4], FrameMetrics::START_SCROLL_ID + 4,
                              CSSRect(0, 50, 100, 100));
