...
class TextureSourceOGL {
 public:
  TextureSourceOGL() : mHasCachedSamplingFilter(false) {}
 ...
 */
class GLTextureSource : public TextureSource, public TextureSourceOGL {
 public:
  GLTextureSource(TextureSourceProvider* aProvider, GLuint aTextureHandle,
                  GLenum aTarget, gfx::IntSize aSize,
                  gfx::SurfaceFormat aFormat, bool aExternallyOwned = false);
