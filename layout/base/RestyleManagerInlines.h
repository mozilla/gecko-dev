...
MOZ_DEFINE_STYLO_METHODS(RestyleManager, GeckoRestyleManager,
                         ServoRestyleManager)

void RestyleManager::PostRestyleEvent(dom::Element* aElement,
...
void RestyleManager::AttributeWillChange(dom::Element* aElement,
...
void RestyleManager::AttributeChanged(dom::Element* aElement,
...
nsresult RestyleManager::ReparentStyleContext(nsIFrame* aFrame) {
