...
CSS_STATE_PSEUDO_CLASS(focusWithin, ":focus-within", 0, "",
                       NS_EVENT_STATE_FOCUS_WITHIN)
CSS_STATE_PSEUDO_CLASS(hover, ":hover", 0, "", NS_EVENT_STATE_HOVER)
CSS_STATE_PSEUDO_CLASS(mozDragOver, ":-moz-drag-over", 0, "",
...
CSS_STATE_PSEUDO_CLASS(mozStyleeditorTransitioning,
...
CSS_STATE_PSEUDO_CLASS(mozHandlerVulnerableNoUpdate,
...
CSS_STATE_PSEUDO_CLASS(outOfRange, ":out-of-range", 0, "",
...
CSS_STATE_PSEUDO_CLASS(mozPlaceholder, ":-moz-placeholder", 0, "",
