...
class nsStyleSet final {
 public:
  ...
  already_AddRefed<mozilla::GeckoStyleContext> ResolveStyleWithReplacement(
      mozilla::dom::Element* aElement, mozilla::dom::Element* aPseudoElement,
      mozilla::GeckoStyleContext* aNewParentContext,
      mozilla::GeckoStyleContext* aOldStyleContext, nsRestyleHint aReplacements,
      uint32_t aFlags = 0);
  ...
  already_AddRefed<mozilla::GeckoStyleContext> ResolveStyleByRemovingAnimation(
      mozilla::dom::Element* aElement,
      mozilla::GeckoStyleContext* aStyleContext, nsRestyleHint aWhichToRemove);
  ...
  already_AddRefed<mozilla::GeckoStyleContext> ResolveXULTreePseudoStyle(
      mozilla::dom::Element* aParentElement, nsICSSAnonBoxPseudo* aPseudoTag,
      mozilla::GeckoStyleContext* aParentContext,
  ...
  nsRestyleHint HasStateDependentStyle(
      ...
      mozilla::dom::Element* aPseudoElement, mozilla::EventStates aStateMask);
 ...
 private:
  ...
  already_AddRefed<mozilla::GeckoStyleContext> GetContext(
      mozilla::GeckoStyleContext* aParentContext, nsRuleNode* aRuleNode,
      nsRuleNode* aVisitedRuleNode, nsAtom* aPseudoTag,
      mozilla::CSSPseudoElementType aPseudoType,
      mozilla::dom::Element* aElementForAnimation, uint32_t aFlags);
  ...
  RefPtr<nsRuleNode>
      mRuleTree;  // This is the root of our rule tree.  It is a
...
inline void nsRuleNode::Release() {
  if (--mRefCnt == 0) {
    MOZ_ASSERT(mPresContext->StyleSet()->IsGecko(),
               "ServoStyleSets should not have rule nodes");
