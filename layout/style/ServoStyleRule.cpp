...
NS_INTERFACE_MAP_BEGIN(ServoStyleRuleDeclaration)
  ...
  css::Rule* ServoStyleRuleDeclaration::GetParentRule() { return Rule(); }
  ...
  uint16_t ServoStyleRule::Type() const { return CSSRuleBinding::STYLE_RULE; }

  void ServoStyleRule::GetCssText(nsAString & aCssText) const {
  ...
  void ServoStyleRule::GetSelectorText(nsAString & aSelectorText) {
    Servo_StyleRule_GetSelectorText(mRawRule, &aSelectorText);
  }

  void ServoStyleRule::SetSelectorText(const nsAString& aSelectorText) {
  ...
  nsresult ServoStyleRule::SelectorMatchesElement(
