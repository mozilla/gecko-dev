...
NS_INTERFACE_MAP_BEGIN_CYCLE_COLLECTION(nsDOMCSSAttributeDeclaration)
  ...
  DeclarationBlock* nsDOMCSSAttributeDeclaration::GetCSSDeclaration(
    ...
    if (!mIsSMILOverride &&
      ...
      nsNodeUtils::AttributeWillChange(
          mElement, kNameSpaceID_None, nsGkAtoms::style,
          dom::MutationEventBinding::MODIFICATION, nullptr);
    }
  ...
  void nsDOMCSSAttributeDeclaration::GetCSSParsingEnvironment(
    ...
    aCSSParseEnv.mPrincipal =
        (aSubjectPrincipal ? aSubjectPrincipal : mElement->NodePrincipal());
  ...
  css::Rule* nsDOMCSSAttributeDeclaration::GetParentRule() { return nullptr; }
