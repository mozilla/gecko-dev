...
#define STYLE_STRUCT_INHERITED(name, checkdata_cb) eStyleStruct_##name,
...
#define STYLE_STRUCT_RESET(name, checkdata_cb) eStyleStruct_##name,
...
typedef decltype(nsStyleStructID(0) +
                 nsStyleStructID(0)) nsStyleStructID_size_t;
