// |reftest| shell-option(--enable-uint8array-base64) shell-option(--enable-float16array) skip-if(!Uint8Array.fromBase64||!xulRuntime.shell) -- uint8array-base64 is not enabled unconditionally, requires shell-options
