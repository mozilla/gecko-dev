...
void MacroAssembler::remainder32(Register rhs,
                                 Register srcDest,
                                 bool isUnsigned) {
  MOZ_CRASH();
}
...
void MacroAssembler::minFloat32(FloatRegister other,
                                FloatRegister srcDest,
                                bool handleNaN) {
  MOZ_CRASH();
}

void MacroAssembler::minDouble(FloatRegister other,
                               FloatRegister srcDest,
                               bool handleNaN) {
  MOZ_CRASH();
}

void MacroAssembler::maxFloat32(FloatRegister other,
                                FloatRegister srcDest,
                                bool handleNaN) {
  MOZ_CRASH();
}

void MacroAssembler::maxDouble(FloatRegister other,
                               FloatRegister srcDest,
                               bool handleNaN) {
  MOZ_CRASH();
}
...
void MacroAssembler::rotateLeft64(Register count,
                                  Register64 src,
                                  Register64 dest,
                                  Register temp) {
  MOZ_CRASH();
...
void MacroAssembler::rotateLeft64(Imm32 count,
                                  Register64 src,
                                  Register64 dest,
                                  Register temp) {
  MOZ_CRASH();
...
void MacroAssembler::rotateRight(Register count,
                                 Register input,
                                 Register dest) {
  MOZ_CRASH();
}
...
void MacroAssembler::rotateRight64(Register count,
                                   Register64 src,
                                   Register64 dest,
                                   Register temp) {
  MOZ_CRASH();
...
void MacroAssembler::rotateRight64(Imm32 count,
                                   Register64 src,
                                   Register64 dest,
                                   Register temp) {
  MOZ_CRASH();
...
void MacroAssembler::popcnt64(Register64 input,
                              Register64 output,
                              Register tmp) {
  MOZ_CRASH();
}
...
void MacroAssembler::cmp8Set(Condition cond,
                             Address lhs,
                             Imm32 rhs,
                             Register dest) {
  MOZ_CRASH();
...
void MacroAssembler::cmp16Set(Condition cond,
                              Address lhs,
                              Imm32 rhs,
                              Register dest) {
  MOZ_CRASH();
...
void MacroAssembler::branchFloat(DoubleCondition cond,
                                 FloatRegister lhs,
                                 FloatRegister rhs,
                                 Label* label) {
  MOZ_CRASH();
...
void MacroAssembler::branchDouble(DoubleCondition cond,
                                  FloatRegister lhs,
                                  FloatRegister rhs,
                                  Label* label) {
  MOZ_CRASH();
...
void MacroAssembler::decBranchPtr(Condition cond,
                                  Register lhs,
                                  Imm32 rhs,
                                  Label* label) {
  MOZ_CRASH();
...
void MacroAssembler::branchTestInt32Truthy(bool b,
                                           const ValueOperand& value,
                                           Label* label) {
  MOZ_CRASH();
}
...
void MacroAssembler::branchTestDoubleTruthy(bool b,
                                            FloatRegister value,
                                            Label* label) {
  MOZ_CRASH();
}
...
template <typename T>
void MacroAssembler::testNumberSet(Condition cond,
                                   const T& src,
                                   Register dest) {
  MOZ_CRASH();
}
...
template <typename T>
void MacroAssembler::testBooleanSet(Condition cond,
                                    const T& src,
                                    Register dest) {
  MOZ_CRASH();
}
...
template <typename T>
void MacroAssembler::testStringSet(Condition cond,
                                   const T& src,
                                   Register dest) {
  MOZ_CRASH();
}
...
template <typename T>
void MacroAssembler::testSymbolSet(Condition cond,
                                   const T& src,
                                   Register dest) {
  MOZ_CRASH();
}
...
template <typename T>
void MacroAssembler::testBigIntSet(Condition cond,
                                   const T& src,
                                   Register dest) {
  MOZ_CRASH();
}
...
void MacroAssembler::cmp32Load32(Condition cond,
                                 Register lhs,
                                 const Address& rhs,
                                 const Address& src,
                                 Register dest) {
...
void MacroAssembler::cmp32LoadPtr(Condition cond,
                                  const Address& lhs,
                                  Imm32 rhs,
                                  const Address& src,
                                  Register dest) {
...
void MacroAssembler::test32MovePtr(Condition cond,
                                   const Address& addr,
                                   Imm32 mask,
                                   Register src,
                                   Register dest) {
...
void MacroAssembler::spectreMovePtr(Condition cond,
                                    Register src,
                                    Register dest) {
  MOZ_CRASH();
}

void MacroAssembler::spectreZeroRegister(Condition cond,
                                         Register scratch,
                                         Register dest) {
  MOZ_CRASH();
}
