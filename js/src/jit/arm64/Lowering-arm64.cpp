...
void LIRGeneratorARM64::visitBox(MBox* box) { MOZ_CRASH("visitBox"); }

void LIRGeneratorARM64::visitUnbox(MUnbox* unbox) { MOZ_CRASH("visitUnbox"); }

void LIRGeneratorARM64::visitReturn(MReturn* ret) { MOZ_CRASH("visitReturn"); }
...
void LIRGeneratorARM64::defineUntypedPhi(MPhi* phi, size_t lirIndex) {
...
void LIRGeneratorARM64::lowerDivI(MDiv* div) { MOZ_CRASH("lowerDivI"); }
...
void LIRGeneratorARM64::visitPowHalf(MPowHalf* ins) {
...
void LIRGeneratorARM64::lowerUrshD(MUrsh* mir) { MOZ_CRASH("lowerUrshD"); }

void LIRGeneratorARM64::visitWasmNeg(MWasmNeg* ins) {
  MOZ_CRASH("visitWasmNeg");
}

void LIRGeneratorARM64::visitWasmSelect(MWasmSelect* ins) {
...
void LIRGeneratorARM64::visitWasmUnsignedToDouble(MWasmUnsignedToDouble* ins) {
  MOZ_CRASH("visitWasmUnsignedToDouble");
}

void LIRGeneratorARM64::visitWasmUnsignedToFloat32(
    MWasmUnsignedToFloat32* ins) {
  MOZ_CRASH("visitWasmUnsignedToFloat32");
}

void LIRGeneratorARM64::visitAsmJSLoadHeap(MAsmJSLoadHeap* ins) {
  MOZ_CRASH("visitAsmJSLoadHeap");
}

void LIRGeneratorARM64::visitAsmJSStoreHeap(MAsmJSStoreHeap* ins) {
  MOZ_CRASH("visitAsmJSStoreHeap");
}

void LIRGeneratorARM64::visitWasmCompareExchangeHeap(
    MWasmCompareExchangeHeap* ins) {
  MOZ_CRASH("visitWasmCompareExchangeHeap");
}

void LIRGeneratorARM64::visitWasmAtomicExchangeHeap(
    MWasmAtomicExchangeHeap* ins) {
  MOZ_CRASH("visitWasmAtomicExchangeHeap");
}

void LIRGeneratorARM64::visitWasmAtomicBinopHeap(MWasmAtomicBinopHeap* ins) {
...
void LIRGeneratorARM64::visitAtomicTypedArrayElementBinop(
    MAtomicTypedArrayElementBinop* ins) {
  MOZ_CRASH("NYI");
}

void LIRGeneratorARM64::visitCompareExchangeTypedArrayElement(
    MCompareExchangeTypedArrayElement* ins) {
  MOZ_CRASH("NYI");
}

void LIRGeneratorARM64::visitAtomicExchangeTypedArrayElement(
    MAtomicExchangeTypedArrayElement* ins) {
  MOZ_CRASH("NYI");
}

void LIRGeneratorARM64::visitSubstr(MSubstr* ins) { MOZ_CRASH("visitSubstr"); }

void LIRGeneratorARM64::visitRandom(MRandom* ins) {
  LRandom* lir = new (alloc()) LRandom(temp(), temp(), temp());
  defineFixed(lir, ins, LFloatReg(ReturnDoubleReg));
}

void LIRGeneratorARM64::visitWasmTruncateToInt64(MWasmTruncateToInt64* ins) {
  MOZ_CRASH("NY");
}

void LIRGeneratorARM64::visitWasmLoad(MWasmLoad* ins) { MOZ_CRASH("NY"); }

void LIRGeneratorARM64::visitWasmStore(MWasmStore* ins) { MOZ_CRASH("NY"); }

void LIRGeneratorARM64::visitInt64ToFloatingPoint(MInt64ToFloatingPoint* ins) {
  MOZ_CRASH("NY");
}

void LIRGeneratorARM64::visitCopySign(MCopySign* ins) { MOZ_CRASH("NY"); }

void LIRGeneratorARM64::visitExtendInt32ToInt64(MExtendInt32ToInt64* ins) {
  MOZ_CRASH("NYI");
}

void LIRGeneratorARM64::visitSignExtendInt64(MSignExtendInt64* ins) {
  MOZ_CRASH("NYI");
}
