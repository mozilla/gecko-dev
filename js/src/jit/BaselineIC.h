...
class ICCall_Scripted : public ICMonitoredStub {
 ...
 public:
  static ICCall_Scripted* Clone(JSContext* cx, ICStubSpace* space,
...
class ICCall_AnyScripted : public ICMonitoredStub {
 ...
 public:
  static ICCall_AnyScripted* Clone(JSContext* cx, ICStubSpace* space,
                                   ICStub* firstMonitorStub,
...
class ICCall_Native : public ICMonitoredStub {
 ...
 public:
  static ICCall_Native* Clone(JSContext* cx, ICStubSpace* space,
  ...
  class Compiler : public ICCallStubCompiler {
   ...
   public:
    Compiler(JSContext* cx, ICStub* firstMonitorStub, HandleFunction callee,
             ...
             bool ignoresReturnValue, bool isSpread, uint32_t pcOffset)
...
class ICCall_ClassHook : public ICMonitoredStub {
 ...
 public:
  static ICCall_ClassHook* Clone(JSContext* cx, ICStubSpace* space,
                                 ICStub* firstMonitorStub,
...
class ICCall_ScriptedApplyArguments : public ICMonitoredStub {
 ...
 public:
  static ICCall_ScriptedApplyArguments* Clone(
