...
bool ICBinaryArith_Int32::Compiler::generateStubCode(MacroAssembler& masm) {
  ...
  switch (op_) {
    ...
    case JSOP_MUL: {
      masm.unboxInt32(R0, ExtractTemp0);
      masm.unboxInt32(R1, ExtractTemp1);
      masm.ma_mul_branch_overflow(scratchReg, ExtractTemp0, ExtractTemp1,
                                  &failure);
    ...
    case JSOP_MOD: {
      ...
      masm.ma_b(ExtractTemp0, Imm32(INT_MIN), &divTest1, Assembler::NotEqual,
                ShortJump);
      ...
      masm.ma_b(ExtractTemp0, Imm32(0), &divTest2, Assembler::NotEqual,
                ShortJump);
      ...
      if (op_ == JSOP_DIV) {
        ...
        masm.ma_b(ExtractTemp0, Imm32(0), &failure, Assembler::LessThan,
                  ShortJump);
        masm.bind(&done);
        masm.tagValue(JSVAL_TYPE_INT32, scratchReg, R0);
      }
...
bool ICUnaryArith_Int32::Compiler::generateStubCode(MacroAssembler& masm) {
  ...
  switch (op) {
    ...
    case JSOP_NEG:
      ...
      masm.branchTest32(Assembler::Zero, ExtractTemp0, Imm32(INT32_MAX),
                        &failure);
