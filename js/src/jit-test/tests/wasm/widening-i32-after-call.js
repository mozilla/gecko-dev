// |jit-test| skip-if: !hasDisassembler() || !(wasmCompileMode() == "baseline" || wasmCompileMode() == "ion") || !(getBuildConfiguration("x64") && !getBuildConfiguration("arm-simulator") && !getBuildConfiguration("arm64-simulator") && !getBuildConfiguration("mips64-simulator") && !getBuildConfiguration("riscv64-simulator"))
