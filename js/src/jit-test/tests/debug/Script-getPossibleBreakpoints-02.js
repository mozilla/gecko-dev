...
function onDebuggerStatement(frame) {
  ...
  assertBPError({ minLine: 1, minColumn: "2" }, "minColumn", "not a positive integer in valid range");
  assertBPError({ minLine: 1, minColumn: 0 }, "minColumn", "not a positive integer in valid range");
  assertBPError({ minLine: 1, minColumn: -1 }, "minColumn", "not a positive integer in valid range");
  ...
  assertBPError({ maxLine: 1, maxColumn: "2" }, "maxColumn", "not a positive integer in valid range");
  assertBPError({ maxLine: 1, maxColumn: 0 }, "maxColumn", "not a positive integer in valid range");
  assertBPError({ maxLine: 1, maxColumn: -1 }, "maxColumn", "not a positive integer in valid range");
