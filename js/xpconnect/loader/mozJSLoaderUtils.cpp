...
nsresult ReadCachedScript(StartupCache* cache, nsACString& uri, JSContext* cx,
  ...
  if (code == JS::TranscodeResult_Ok) return NS_OK;

  if ((code & JS::TranscodeResult_Failure) != 0) return NS_ERROR_FAILURE;
