...
class JavaScriptBase : public WrapperOwner, public WrapperAnswer, public Base {
 ...
 public:
  ...
  mozilla::ipc::IPCResult RecvGetPropertyDescriptor(
      const uint64_t& objId, const JSIDVariant& id, ReturnStatus* rs,
      PPropertyDescriptor* out) override {
    if (!Answer::RecvGetPropertyDescriptor(ObjectId::deserialize(objId), id, rs,
                                           out)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvGetOwnPropertyDescriptor(
      const uint64_t& objId, const JSIDVariant& id, ReturnStatus* rs,
      PPropertyDescriptor* out) override {
    if (!Answer::RecvGetOwnPropertyDescriptor(ObjectId::deserialize(objId), id,
                                              rs, out)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvDefineProperty(const uint64_t& objId,
                                             ...
                                             ReturnStatus* rs) override {
    if (!Answer::RecvDefineProperty(ObjectId::deserialize(objId), id, flags,
                                    rs)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvGet(const uint64_t& objId,
    ...
    if (!Answer::RecvGet(ObjectId::deserialize(objId), receiverVar, id, rs,
                         result)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvSet(const uint64_t& objId, const JSIDVariant& id,
                                  ...
                                  const JSVariant& receiverVar,
                                  ReturnStatus* rs) override {
    if (!Answer::RecvSet(ObjectId::deserialize(objId), id, value, receiverVar,
                         rs)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvCallOrConstruct(
    ...
    if (!Answer::RecvCallOrConstruct(ObjectId::deserialize(objId), Move(argv),
                                     construct, rs, result, outparams)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  }
  ...
  mozilla::ipc::IPCResult RecvGetBuiltinClass(const uint64_t& objId,
    ...
    if (!Answer::RecvGetBuiltinClass(ObjectId::deserialize(objId), rs,
                                     classValue)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvGetPrototypeIfOrdinary(
      ...
      ObjectOrNullVariant* result) override {
    if (!Answer::RecvGetPrototypeIfOrdinary(ObjectId::deserialize(objId), rs,
                                            isOrdinary, result)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvRegExpToShared(const uint64_t& objId,
    ...
    if (!Answer::RecvRegExpToShared(ObjectId::deserialize(objId), rs, source,
                                    flags)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
  ...
  mozilla::ipc::IPCResult RecvGetPropertyKeys(
    ...
    if (!Answer::RecvGetPropertyKeys(ObjectId::deserialize(objId), flags, rs,
                                     ids)) {
      return IPC_FAIL_NO_REASON(this);
    }
    return IPC_OK();
