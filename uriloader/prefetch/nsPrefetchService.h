...
class nsPrefetchService final : public nsIPrefetchService,
 ...
 private:
  ...
  nsresult Prefetch(nsIURI *aURI, nsIURI *aReferrerURI, nsIDOMNode *aSource,
                    bool aExplicit);

  nsresult Preload(nsIURI *aURI, nsIURI *aReferrerURI, nsIDOMNode *aSource,
                   nsContentPolicyType aPolicyType);

  void AddProgressListener();
  void RemoveProgressListener();
  nsresult EnqueueURI(nsIURI *aURI, nsIURI *aReferrerURI, nsIDOMNode *aSource,
                      nsPrefetchNode **node);
...
class nsPrefetchNode final : public nsIStreamListener,
 ...
 public:
  ...
  nsPrefetchNode(nsPrefetchService *aPrefetchService, nsIURI *aURI,
                 nsIURI *aReferrerURI, nsIDOMNode *aSource,
