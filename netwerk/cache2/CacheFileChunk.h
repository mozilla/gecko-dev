...
class CacheFileChunk : public CacheFileIOListener, public CacheMemoryConsumer {
 public:
 ...
 private:
  ...
  Atomic<bool>
      mActiveChunk;  // Is true iff the chunk is in CacheFile::mChunks.
  ...
  bool const
      mLimitAllocation : 1;  // Whether this chunk respects limit for disk
                             // chunks memory usage.
