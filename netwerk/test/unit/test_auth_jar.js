...
function run_test() {
  ...
  am.setAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", "example.com", "user", "pass", app1);
  am.setAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", "example.com", "user3", "pass3", app1browser);
  am.setAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", "example.com", "user2", "pass2", app10);
  ...
  try {
    am.getAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", domain, user, pass, app1browser);
  ...
  am.getAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", domain, user, pass, app1);
  do_check_eq(domain.value, "example.com");
  do_check_eq(user.value, "user");
  do_check_eq(pass.value, "pass");


  am.getAuthIdentity("http", "a.example.com", -1, "basic", "realm", "", domain, user, pass, app10);
  do_check_eq(domain.value, "example.com");
