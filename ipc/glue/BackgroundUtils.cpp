...
nsresult LoadInfoToLoadInfoArgs(nsILoadInfo* aLoadInfo,
  ...
  *aOptionalLoadInfoArgs = LoadInfoArgs(
      ...
      sandboxedLoadingPrincipalInfo, optionalResultPrincipalURI,
...
nsresult LoadInfoArgsToLoadInfo(
  ...
  RefPtr<mozilla::LoadInfo> loadInfo = new mozilla::LoadInfo(
      ...
      sandboxedLoadingPrincipal, resultPrincipalURI, clientInfo,
      ...
      redirectChain, Move(ancestorPrincipals),
...
nsresult MergeParentLoadInfoForwarder(
    ParentLoadInfoForwarderArgs const& outLoadInfoChildForwardArgs,
    nsILoadInfo* aLoadInfo) {
  if (!aLoadInfo) {
    return NS_OK;
  }
