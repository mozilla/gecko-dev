...
NS_IMETHODIMP
nsNSSSocketInfo::GetInsecure(bool *arg)
{
  *arg = mInsecure;
  return NS_OK;
}
...
NS_IMETHODIMP
nsNSSSocketInfo::SetInsecure(bool arg)
{
  mInsecure = arg;
  return NS_OK;
}
...
NS_IMETHODIMP
nsNSSSocketInfo::JoinableConnection(const nsACString& hostname, bool* _retval)
{
                                ...
                                bool* _retval)
{
  *_retval = false;
  ...
  JoinableConnection(hostname, _retval);
