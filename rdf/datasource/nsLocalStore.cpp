...
class LocalStoreImpl : public nsILocalStore,
 ...
 protected:
  ...
  friend nsresult NS_NewLocalStore(nsISupports* aOuter, REFNSIID aIID,
                                   void** aResult);
 ...
 public:
  ...
  NS_IMETHOD GetSource(nsIRDFResource* aProperty, nsIRDFNode* aTarget,
                       bool aTruthValue, nsIRDFResource** aSource) override {
    return mInner->GetSource(aProperty, aTarget, aTruthValue, aSource);
  }

  NS_IMETHOD GetSources(nsIRDFResource* aProperty, nsIRDFNode* aTarget,
                        bool aTruthValue,
                        nsISimpleEnumerator** aSources) override {
    return mInner->GetSources(aProperty, aTarget, aTruthValue, aSources);
  }

  NS_IMETHOD GetTarget(nsIRDFResource* aSource, nsIRDFResource* aProperty,
                       bool aTruthValue, nsIRDFNode** aTarget) override {
    return mInner->GetTarget(aSource, aProperty, aTruthValue, aTarget);
  }

  NS_IMETHOD GetTargets(nsIRDFResource* aSource, nsIRDFResource* aProperty,
                        bool aTruthValue,
  ...
  NS_IMETHOD Assert(nsIRDFResource* aSource, nsIRDFResource* aProperty,
                    nsIRDFNode* aTarget, bool aTruthValue) override {
  ...
  NS_IMETHOD HasAssertion(nsIRDFResource* aSource, nsIRDFResource* aProperty,
    ...
    return mInner->HasAssertion(aSource, aProperty, aTarget, aTruthValue,
                                hasAssertion);
  }
...
nsresult NS_NewLocalStore(nsISupports* aOuter, REFNSIID aIID, void** aResult) {
...
nsresult LocalStoreImpl::CreateLocalStore(nsIFile* aFile) {
  nsresult rv;
...
nsresult LocalStoreImpl::LoadData() {
  nsresult rv;
...
NS_IMETHODIMP
LocalStoreImpl::DoCommand(nsISupports* aSources, nsIRDFResource* aCommand,
                          nsISupports* aArguments) {
  return NS_ERROR_NOT_IMPLEMENTED;
}

NS_IMETHODIMP
LocalStoreImpl::Observe(nsISupports* aSubject, const char* aTopic,
