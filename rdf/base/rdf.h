...
#define NS_RDF_DATASOURCE_CONTRACTID_PREFIX \
  NS_RDF_DATASOURCE_CONTRACTID "?name="
#define NS_RDF_RESOURCE_FACTORY_CONTRACTID "@mozilla.org/rdf/resource-factory;1"
#define NS_RDF_RESOURCE_FACTORY_CONTRACTID_PREFIX \
  NS_RDF_RESOURCE_FACTORY_CONTRACTID "?name="
#define NS_RDF_INFER_DATASOURCE_CONTRACTID_PREFIX \
  NS_RDF_CONTRACTID "/infer-datasource;1?engine="
...
#define NS_RDF_DELEGATEFACTORY_CONTRACTID_PREFIX \
  NS_RDF_DELEGATEFACTORY_CONTRACTID "?key="
