 ...
 */
bool HTMLEditUtils::IsFormatNode(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
...
bool HTMLEditUtils::IsHeader(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
  MOZ_ASSERT(node);
 ...
 */
bool HTMLEditUtils::IsParagraph(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsListItem(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsTableElement(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsTableElementButNotTable(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsTableRow(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsTableCell(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsList(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsOrderedList(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsUnorderedList(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsBlockquote(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsPre(nsIDOMNode* aNode) {
...
bool HTMLEditUtils::IsImage(nsIDOMNode* aNode) {
...
bool HTMLEditUtils::IsLink(nsINode* aNode) {
  ...
  RefPtr<HTMLAnchorElement> anchor =
      HTMLAnchorElement::FromContentOrNull(aNode->AsContent());
  if (!anchor) {
    return false;
  }
 ...
 */
bool HTMLEditUtils::IsDiv(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsMozDiv(nsIDOMNode* aNode) {
 ...
 */
bool HTMLEditUtils::IsMailCite(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
 ...
 */
bool HTMLEditUtils::IsFormWidget(nsIDOMNode* aNode) {
  MOZ_ASSERT(aNode);
  nsCOMPtr<nsINode> node = do_QueryInterface(aNode);
...
bool HTMLEditUtils::SupportsAlignAttr(nsINode& aNode) {
  ...
  // are marked to allow containment of certain groups by setting the
