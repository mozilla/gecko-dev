...
nsresult nsComposerController::RegisterEditorDocStateCommands(
  ...
  NS_REGISTER_NEXT_COMMAND(nsDocumentStateCommand,
                           "obs_documentWillBeDestroyed")
  NS_REGISTER_LAST_COMMAND(nsDocumentStateCommand,
  ...
  NS_REGISTER_NEXT_COMMAND(nsSetDocumentStateCommand,
                           "cmd_defaultParagraphSeparator")
  NS_REGISTER_NEXT_COMMAND(nsSetDocumentStateCommand,
                           "cmd_enableObjectResizing")
  NS_REGISTER_LAST_COMMAND(nsSetDocumentStateCommand,
...
// static
nsresult nsComposerController::RegisterHTMLEditorCommands(
    nsIControllerCommandTable *inCommandTable) {
  // Edit menu
  ...
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_underline",
                            nsGkAtoms::u);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_tt", nsGkAtoms::tt);

  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_strikethrough",
                            nsGkAtoms::strike);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_superscript",
                            nsGkAtoms::sup);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_subscript",
                            nsGkAtoms::sub);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_nobreak",
                            nsGkAtoms::nobr);

  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_em", nsGkAtoms::em);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_strong",
                            nsGkAtoms::strong);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_cite",
                            nsGkAtoms::cite);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_abbr",
                            nsGkAtoms::abbr);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_acronym",
                            nsGkAtoms::acronym);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_code",
                            nsGkAtoms::code);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_samp",
                            nsGkAtoms::samp);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_var", nsGkAtoms::var);
  NS_REGISTER_STYLE_COMMAND(nsStyleUpdatingCommand, "cmd_removeLinks",
                            nsGkAtoms::href);
  ...
  NS_REGISTER_TAG_COMMAND(nsInsertTagCommand, "cmd_insertLinkNoUI",
                          nsGkAtoms::a);
  NS_REGISTER_TAG_COMMAND(nsInsertTagCommand, "cmd_insertImageNoUI",
                          nsGkAtoms::img);
